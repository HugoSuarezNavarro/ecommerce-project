...
public class CustomExceptionHandler {
    ...
    @ExceptionHandler({MethodArgumentNotValidException.class}) // Once JSON serialization is made --> throws if theres a validation error
    ...
    @ExceptionHandler(HttpMessageNotReadableException.class) // throws error when serializing JSON --> before validation (@Valid)
